...
RcppExport SEXP bayesm_my_llmnl_con(SEXP betaSEXP, SEXP ySEXP, SEXP XSEXP, SEXP count_outSEXP,SEXP initial_price_idSEXP,SEXP initial_price_state_droppedSEXP,           //same1
                             SEXP s1SEXP,SEXP transition_matrix_median_stepsSEXP,SEXP price_transition_statesSEXP,           //..
                             SEXP vec_price_states_probsSEXP,SEXP draws_lengthSEXP,SEXP number_price_simulationsSEXP,     //..
                             SEXP flag_markovianSEXP,SEXP flag_know_stateSEXP,SEXP SignResSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< vec const& >::type beta(betaSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type count_out(count_outSEXP);
    Rcpp::traits::input_parameter< int >::type initial_price_id(initial_price_idSEXP);
    Rcpp::traits::input_parameter< mat >::type initial_price_state_dropped(initial_price_state_droppedSEXP);
    Rcpp::traits::input_parameter< int >::type s1(s1SEXP);
    Rcpp::traits::input_parameter< mat >::type transition_matrix_median_steps(transition_matrix_median_stepsSEXP);
    Rcpp::traits::input_parameter< mat >::type price_transition_states(price_transition_statesSEXP);
    Rcpp::traits::input_parameter< vec const& >::type vec_price_states_probs(vec_price_states_probsSEXP);
    Rcpp::traits::input_parameter< int const& >::type draws_length(draws_lengthSEXP);
    Rcpp::traits::input_parameter< int const& >::type number_price_simulations(number_price_simulationsSEXP);
    Rcpp::traits::input_parameter< bool const& >::type flag_markovian(flag_markovianSEXP);
    Rcpp::traits::input_parameter< bool const& >::type flag_know_state(flag_know_stateSEXP);
    Rcpp::traits::input_parameter< vec const& >::type SignRes(SignResSEXP);
    rcpp_result_gen = Rcpp::wrap(my_llmnl_con(beta, y, X, count_out, initial_price_id, initial_price_state_dropped,
...
// rhierMnlRwMixture_rcpp
List my_rhierMnlRwMixture_rcpp(List const& lgtdata, mat const& Z,
                                 ...
                                 // int count_out,int initial_price_id,mat const& initial_price_state_dropped,
...
RcppExport SEXP bayesm_my_rhierMnlRwMixture_rcpp(SEXP lgtdataSEXP, SEXP   ZSEXP,
                                 SEXP deltabarSEXP, SEXP AdSEXP, SEXP mubarSEXP, SEXP  AmuSEXP,
                                 SEXP nuSEXP, SEXP VSEXP, SEXP sSEXP,
                                 SEXP RSEXP, SEXP keepSEXP, SEXP nprintSEXP, SEXP drawdeltaSEXP,
                                 SEXP olddeltaSEXP,  SEXP   aSEXP, SEXP oldprobSEXP, SEXP oldbetasSEXP, SEXP indSEXP, SEXP SignResSEXP){
                                 // SEXP count_outSEXP,SEXP initial_price_idSEXP,SEXP initial_price_state_droppedSEXP,
                                 // SEXP s1SEXP,SEXP transition_matrix_median_stepsSEXP,SEXP price_transition_statesSEXP,
                                 // SEXP vec_price_states_probsSEXP,SEXP draws_lengthSEXP,SEXP number_price_simulationsSEXP,
                                 // SEXP flag_markovianSEXP,SEXP flag_know_stateSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List const& >::type lgtdata(lgtdataSEXP);
    ...
    // Rcpp::traits::input_parameter< int >::type count_out(count_outSEXP);
    // Rcpp::traits::input_parameter< int >::type initial_price_id(initial_price_idSEXP);
    // Rcpp::traits::input_parameter< mat const&>::type initial_price_state_dropped(initial_price_state_droppedSEXP);
    // Rcpp::traits::input_parameter< int >::type s1(s1SEXP);
    // Rcpp::traits::input_parameter< mat const&>::type transition_matrix_median_steps(transition_matrix_median_stepsSEXP);
    // Rcpp::traits::input_parameter< mat const&>::type price_transition_states(price_transition_statesSEXP);
    // Rcpp::traits::input_parameter< vec const& >::type vec_price_states_probs(vec_price_states_probsSEXP);
    // Rcpp::traits::input_parameter< int >::type draws_length(draws_lengthSEXP);
    // Rcpp::traits::input_parameter< int >::type number_price_simulations(number_price_simulationsSEXP);
    // Rcpp::traits::input_parameter< bool >::type flag_markovian(flag_markovianSEXP);
    // Rcpp::traits::input_parameter< bool >::type flag_know_state(flag_know_stateSEXP);
    rcpp_result_gen = Rcpp::wrap(my_rhierMnlRwMixture_rcpp(lgtdata, Z,deltabar, Ad, mubar, Amu,
                                          nu, V, s,
                                          R, keep, nprint, drawdelta,
                                          olddelta,  a, oldprob, oldbetas, ind, SignRes));
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"bayesm_my_llmnl_con", (DL_FUNC) &bayesm_my_llmnl_con, 15},
    {"bayesm_llmnl_con", (DL_FUNC) &bayesm_llmnl_con, 4},
    {"bayesm_my_rhierMnlRwMixture_rcpp", (DL_FUNC) &bayesm_my_rhierMnlRwMixture_rcpp, 19},
