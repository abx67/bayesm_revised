...
rbprobitGibbs_rcpp_loop <- function(y, X, Abetabar, root, beta, sigma, trunpt, above, R, keep, nprint) {
    .Call('bayesm_rbprobitGibbs_rcpp_loop', PACKAGE = 'bayesm', y, X, Abetabar, root, beta, sigma, trunpt, above, R, keep, nprint)
}
...
llmnl_con <- function(betastar, y, X, SignRes = as.numeric( c(0))) {
    .Call('bayesm_llmnl_con', PACKAGE = 'bayesm', betastar, y, X, SignRes)
}

my_llmnl_con <- function(betastar, y, X, count_out, initial_price_id, initial_price_state_dropped,
                                          s1, transition_matrix_median_steps, price_transition_states,
                                            vec_price_states_probs, draws_length, number_price_simulations,
                                          flag_markovian, flag_know_state,SignRes = as.numeric( c(0))) {
    .Call('bayesm_my_llmnl_con', PACKAGE = 'bayesm', betastar, y, X, count_out, initial_price_id, initial_price_state_dropped,
                                          s1, transition_matrix_median_steps, price_transition_states,
                                            vec_price_states_probs, draws_length, number_price_simulations,
                                          flag_markovian, flag_know_state,SignRes)
}

my_rhierMnlRwMixture_rcpp <- function(lgtdata, Z,deltabar, Ad, mubar, Amu,
                                          nu, V, s,
    ...
    .Call('bayesm_my_rhierMnlRwMixture_rcpp', PACKAGE = 'bayesm', lgtdata, Z,deltabar, Ad, mubar, Amu,
                                          nu, V, s,
                                          R, keep, nprint, drawdelta,
                                          olddelta,  a, oldprob, oldbetas, ind, SignRes)
                                          # count_out, initial_price_id, initial_price_state_dropped,
...
rhierMnlRwMixture_rcpp_loop <- function(lgtdata, Z, deltabar, Ad, mubar, Amu, nu, V, s, R, keep, nprint, drawdelta, olddelta, a, oldprob, oldbetas, ind, SignRes) {
    .Call('bayesm_rhierMnlRwMixture_rcpp_loop', PACKAGE = 'bayesm', lgtdata, Z, deltabar, Ad, mubar, Amu, nu, V, s, R, keep, nprint, drawdelta, olddelta, a, oldprob, oldbetas, ind, SignRes)
}
